...
if has("gui_running")
	"autocmd filetype cpp nnoremap <silent> <F10> :!start cmd /c "%:p:r:s,$,.exe," & pause<CR>
	"autocmd filetype cpp nnoremap <silent> <F10> :!start cmd /c ./cpp.sh %:r & pause<CR>
	autocmd filetype cpp nnoremap <silent> <F10> :!printf '\e[1;32m================   Running...   ================\n\e[0m' &&./%:r<CR>
else
	autocmd filetype cpp nnoremap <silent> <F10> :vertical terminal ++cols=50 %:r<CR>
endif
